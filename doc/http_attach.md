 ...
 **s**: Handle of the underlying socket. It must be a bytestream protocol.
 ...
 The socket can be cleanly shut down using the handle returned from the **http_detach** function.
 ...
 **hclose**(3) **http_attach_mem**(3) **http_detach**(3) **http_done**(3) **http_recvfield**(3) **http_recvrequest**(3) **http_recvstatus**(3) **http_sendfield**(3) **http_sendrequest**(3) **http_sendstatus**(3) 
